...
```
curl -fsSL -o setup.sh https://github.com/phoenixTW/plane/releases/latest/download/setup.sh
...
```
curl -fsSL -o setup.sh https://github.com/phoenixTW/plane/releases/latest/download/swarm.sh
...
1. Download the restore script using the command below. We suggest downloading it in the same folder as `setup.sh`.
   ...
   ```bash
   curl -fsSL -o restore.sh https://github.com/phoenixTW/plane/releases/latest/download/restore.sh
   chmod +x restore.sh
   ```
...
1. Download the restore script using the command below
   ...
   ```bash
   curl -fsSL -o restore-airgapped.sh https://github.com/phoenixTW/plane/releases/latest/download/restore-airgapped.sh
